...
def main():
    ...
    cf_low_fs, cf_low_ps, cf_low_syns = gen_group_power_spectra(len(cf_low_step), FREQ_RANGE, BG_DEF, cf_iter_low)
    ...
    cf_high_fs, cf_high_ps, cf_high_syns = gen_group_power_spectra(len(cf_high_step), FREQ_RANGE, BG_DEF, cf_iter_high)
    ...
    amp_low_fs, amp_low_ps, amp_low_syns = gen_group_power_spectra(len(amp_low_step), FREQ_RANGE, BG_DEF, amp_iter_low)
    ...
    amp_high_fs, amp_high_ps, amp_high_syns = gen_group_power_spectra(len(amp_high_step), FREQ_RANGE, BG_DEF, amp_iter_high)
    ...
    bw_low_fs, bw_low_ps, bw_low_syns = gen_group_power_spectra(len(bw_low_step), FREQ_RANGE, BG_DEF, bw_iter_low)
    ...
    bw_high_fs, bw_high_ps, bw_high_syns = gen_group_power_spectra(len(bw_high_step), FREQ_RANGE, BG_DEF, bw_iter_high)
    ...
    apc_save = [apc_fs, apc_ps, apc_syns]
